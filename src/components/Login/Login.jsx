...
export const Login = () => {
    ...
    const [firstnamemsg, setFirstnamemsg] = useState("Enter your Email");
    const [ShowfirstnameError, setFirstnameError] = useState(false);


    const [surename, setSurename] = useState("");
    const [surenamemsg, setSurenamemsg] = useState("Enter your Password");
            ...
            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                <div class="col-md-6 p-5 shadow bg-body-tertiary">
                    <form onSubmit={SubmitHandler}>
                        ...
                        <div className='mb-3'>
                            <input value={firstname} onChange={userFirstnameHandler} type="text" placeholder="Your Email" className="form-control" />
                            {ShowfirstnameError && (
                        ...
                        <div className='mb-3'>
                            <input value={surename} onChange={userSurenameHandler} type="text" placeholder="Password" className="form-control" />
                            {ShowsurenameError && (
                    ...
                    <div className='text-center mt-3'>
                        <p>Don't Have an Account? <Link to="/signup" className='hovar-fn text-dark fw-bold'> Sign up now</Link></p>
                    </div>
